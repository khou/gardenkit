...
- [[meta/derived-taxonomies]]: agent-curated aggregate-MOC types (e.g. companies/, vendors/) regenerated each gardener pass from atomic notes
...
_The gardener appends recent notable activity here on each run._

## Conventions

See [[README]] for atomic-note + linking rules.
